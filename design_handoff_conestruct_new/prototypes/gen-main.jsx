    ...
    <main className="main">
      ...
      {status === 'generating' && (
        <div className="status-bar warn">
          <span className="indicator"></span>
          <span>Computing taper, buffer, device spacing, and sign placement…</span>
        </div>
      )}
      {status === 'done' && (
        <div className="status-bar pass">
          <span className="indicator"></span>
          <span>Generated · 3 validation warnings · all CDOT checks pass</span>
          <span className="pill">READY FOR TCS REVIEW</span>
          <span className="ts">1.1s</span>
        </div>
      )}
        ...
        <div className="audit-list">
          ...
          >
            ...
            <div className="citation">
              ...
              MUTCD 2023 · Chapter 6C · Table 6C-3
            </div>
          </AuditItem>
          ...
          >
            ...
            <p style={{ marginTop: 8 }}>
              <a href="#" style={{ color: 'var(--blue)', fontWeight: 500 }}>
