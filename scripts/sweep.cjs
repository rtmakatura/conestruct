...
// issue-301-band-aerial/sweep.cjs, which stays as recorded.  One change:
// it sends the gate's bypass header (scripts/gate.cjs — fails loudly on
// prod without GATE_BYPASS_TOKEN).
//
