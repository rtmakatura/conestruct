/** s2-arc11 live checks (Refs #228) — READ-ONLY, local run against the
 *  issue-228-rail-enrichment worktree's dev server on :3113.  (Prod
...
const OUT = path.join(__dirname, "outS2A11LC");
fs.mkdirSync(OUT, { recursive: true });
const BASE = "http://localhost:3113/sandbox";
