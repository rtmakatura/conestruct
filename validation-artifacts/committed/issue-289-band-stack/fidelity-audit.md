...
| 86 | page padding — main | 24 | padding | 16px 14px 16px 14px | 24px 24px 80px 24px | +8px | all @380 |
| 87 | column width — main | 24 | column width | 880px | 1100px | +220px | all @1440 |
| 88 | page padding — main | 24 | padding | 26px 40px 0px 40px | 32px 40px 80px 40px | +6px | all @1440 |
