"""Verify the snapshot drift is EXACTLY the #224 phase-1 ``sections.site_scan`` leaf, then re-baseline.
...
encoding), The 8 live-compared test_audit_endpoint.py baselines are handled by
rebaseline_endpoint.py (same leaf, same canonical encoder). s2-arc15 copy
of the s2-arc12 script; only this docstring differs.
"""
