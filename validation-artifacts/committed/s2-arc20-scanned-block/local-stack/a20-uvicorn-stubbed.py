"""s2-arc20 local run (from the arc-19 stand-in) — uvicorn with the Overpass mirror list pointed at
the local stand-in (a20-overpass-mock.py on 8766).  Everything else is
