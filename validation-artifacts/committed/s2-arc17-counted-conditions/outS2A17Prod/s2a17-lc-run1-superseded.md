...
**PASS** — A1 scanned audit answers honestly: ok, or the coded refusal — HTTP 200, 26540 ms, status=ok
...
**PASS** — B1 scanned audit PDF renders — HTTP 200, 8959 B, 8883 ms
**PASS** — B2 the audit PDF's Site Conditions table names the five rule-bearing conditions — all five
**FAIL** — B3 the audit-PDF cover line equals the classifier line over the served audit (screen == PDF == classifier) — cover "2 changes · 1 needs attention · 13 checked · 1 pending · reference" vs served "2 changes · 1 needs attention · 12 checked · 1 pending · reference"
**PASS** — C1 proceed-anyway plan sheet + narrative render (200) — sheet HTTP 200 26813 ms · md HTTP 200 1064 ms
...
**PASS** — E3 pinned at Lakewood: the strip settles pre-generate — 20531 ms — VERIFIED · 0 validation warningsREADY FOR TCS REVIEW
...
**PASS** — E5 the strip settles after Generate — 8261 ms — VERIFIED · 2 plan flags ▸REVIEW FLAGS
...
F cycle 1: settled in 1400 ms — VERIFIED · 2 plan flags ▸REVIEW FLAGS
F cycle 2: settled in 944 ms — VERIFIED · 2 plan flags ▸REVIEW FLAGS
F cycle 3: settled in 947 ms — VERIFIED · 2 plan flags ▸REVIEW FLAGS
...
SIZE — scanned audit 11784 B (HTTP 200); scanned audit PDF 8959 B

RESULT: FAILURES 17/18 (+2 INFO)
