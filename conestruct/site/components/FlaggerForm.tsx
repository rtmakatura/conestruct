...
const FLAGGER_COUNTS: Array<{ v: 1 | 2; l: string }> = [
  { v: 1, l: "1 (mutual sight)" },
  { v: 2, l: "2 (one each end)" },
];
  ...
  return (
    <>
      ...
      <FieldGroup label="Flagger" ix="C">
        <Field>
          <LabelRow>Flagger stations</LabelRow>
          <ChipRow
            options={FLAGGER_COUNTS}
            value={scenario.flaggerCount}
            onChange={(v) => set("flaggerCount", v)}
          />
        </Field>
