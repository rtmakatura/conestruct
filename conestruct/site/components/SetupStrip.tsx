...
// ---------------------------------------------------------------------------
// #288 Phase 1 clause 1 — the "Site conditions — scanned" block that
// lived here is GONE from the strip.  It did not change: it MOVED, whole,
// into NEEDS YOU as that block's item rows (Part 1 §8.5,
// components/NeedsYouConditions.tsx), which is where the operator now
// acts from.  The strip keeps the #227 NOT-CHECKED system event below,
// because that is a disclosure about the scan, not a correction of it.
// ---------------------------------------------------------------------------
